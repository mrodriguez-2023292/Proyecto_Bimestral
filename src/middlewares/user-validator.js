...
import { emailExistsAdmin, emailExistsClient, usernameExistsAdmin, usernameExistsClient } from "../helpers/db-validators.js";
...
export const registerValidatorAdmin = [
    ...
    body("email").custom(emailExistsAdmin),
    body("username").custom(usernameExistsAdmin),
